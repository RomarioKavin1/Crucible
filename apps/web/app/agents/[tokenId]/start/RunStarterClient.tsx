  ...
  return (
    <main className="max-w-2xl mx-auto py-12 space-y-8">
      ...
      <div className="p-4 border rounded space-y-2 font-mono text-sm">
        <div>MCP server URL: <span className="bg-zinc-100 px-2 py-1 rounded select-all">{MCP_URL}</span></div>
      ...
      <button onClick={() => setStarted(false)} className="text-sm text-zinc-500 underline">← Pick a different scenario</button>
    </main>
  );
}
